...
*/
data CookingTooMuch;
	input Year CaloriesPerServingMean CaloriesPerServingSD CaloriesPerServingMean 
		CaloriesPerServingSD ServingsPerRecipeMean ServingsPerRecipeSD;
	datalines;
...
data PlotCookingTooMuch;
	...
	/*changed from CaloriesPerRecipe=CaloriesPerRecipeMean to CaloriesPerServing=CaloriesPerServingMean*/
	Lower=CaloriesPerServing-%ConfidenceInterval(CaloriesPerServingSD, &n);

	/*Changed from CaloriesPerRecipe to CaloriesPerServing */
...
proc sgplot data=PlotCookingTooMuch noautolegend;
	...
	yerrorupper=Upper markerattrs=(color=blue symbol=CircleFilled);
